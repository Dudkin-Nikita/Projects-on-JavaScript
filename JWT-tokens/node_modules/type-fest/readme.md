...
- [`Pick<T, K>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1422-L1427) - From `T`, pick a set of properties whose keys are in the union `K`.
	...
	// Creates new type out of the `Bet` interface composed
	// from the Bets' two properties: `title` and `thumbnail`.
	// `BetPreview = {title: string; thumbnail: string}`
	type BetPreview = Pick<Bet, 'title' | 'thumbnail'>;

	// Render a list of bets using only title and description.
	function renderBetPreviews(previews: BetPreview[]): HTMLElement {
			const bets = document.createElement('div');

			for (const preview of previews) {
					// Append preview to the bets.
			}

			return bets;
	}

	const bets = renderBetPreviews([
			{
...
- [`ConstructorParameters<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1456-L1459) - Obtain the parameters of a constructor function type in a tuple.
	...
	const betCache = new InstanceCache(BetModel);
	const amazonBet = betCache.getInstance('Amazon forests burining!');
	```
	</details>
